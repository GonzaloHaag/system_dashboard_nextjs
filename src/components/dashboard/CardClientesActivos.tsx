...
export const CardClientesActivos = ({ clientesActivos, isLoading }: { clientesActivos: number, isLoading: boolean }) => {
            ...
            <div className="flex flex-col items-start gap-y-4">
                {
                    isLoading ? (
                        ...
                        <span className="font-medium text-3xl text-neutral-900 group-hover:text-neutral-200 transition-colors duration-200 w-40 h-10">{clientesActivos}</span>
                    )
                }
